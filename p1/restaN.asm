...
main:	mov ax,@data
		mov ds,ax
		;Codigo donde la resta nos da negativo
		...
		call lee4		
		sub bx,ax		;Ya tenemos en ax algo y ahora lo sumamos con lo antes respaldad
		;add ax,cx
		mov dx,bx		;Movemos a dx para poder imprimir el registro de ax
