...
;https://www.utm.mx/~jjf/le/LE_APENDICE_D.pdf
    ...
    buffer    DB  8000 DUP('$'),20h ; Buffer para contenido maximo de 8000 caracteres
    LIST      LABEL  BYTE                       ;
    MAX_L     DB     21
    LEN       DB     ?
...
;lo que ocurre cuando presionamor enter
pulso_f1:
...
insertar_archivo:
        ...
        mov    bx,contador
        mov    cx,bx
        lea    si, buffer+bx  ;seteamos los contadores en las ultimas posiciones del bufer
        lea    DI, buffer+bx+1
