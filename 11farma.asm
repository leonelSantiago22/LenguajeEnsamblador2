...
ciclo:	mov dx,[si+bx]			;Cargamos la direcion de donde empieza el arreglo 
		call des4			;Es necesario mandar a llamar lo que tenemos para desplegar con dees2
		;int 21h			;Por eso no se utiliza int 21h ya que no se encuentra en hexadecimal
		call spc
		add si,02h				;Decremento para sacar el arreglo al revez
